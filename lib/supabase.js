...
const getCoinData = async () => {
	...
	return { cupHistory, mlcHistory, clasicaHistory, etecsaHistory }
}

const saveCoinData = async (cupValue, mlcValue, clasicaValue, etecsaValue) => {
